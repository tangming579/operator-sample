...
# tangming579.io/operator-sample-bundle:$VERSION and tangming579.io/operator-sample-catalog:$VERSION.
IMAGE_TAG_BASE ?= tangming579.io/operator-sample
...
KUSTOMIZE_INSTALL_SCRIPT ?= "http://172.21.96.1:8091/install_kustomize.sh"
.PHONY: kustomize
